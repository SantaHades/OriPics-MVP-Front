// C2PA 공식 Conformance Trust List 스냅샷 (검증 로직용 — GPSA Issue ① 대응).
//
// 출처(2026-05-30 다운로드, c2pa-org/conformance-public):
//   signing CAs: https://raw.githubusercontent.com/c2pa-org/conformance-public/main/trust-list/C2PA-TRUST-LIST.pem
//   TSA CAs:     https://raw.githubusercontent.com/c2pa-org/conformance-public/main/trust-list/C2PA-TSA-TRUST-LIST.pem
//   trustConfig: https://contentcredentials.org/trust/store.cfg
//
// production 모드(ORIPICS_C2PA_CA_PEM 미설정)에서 createTrustSettings에 주입.
// 이 리스트에 체인이 연결된 서명 인증서(예: SSL.com C2PA Root CA 2025)는 'trusted' 판정.
// 갱신: scripts/update-c2pa-trust-list.mjs 재실행 후 커밋.
// snapshot_date: 2026-05-30

export const C2PA_TRUST_ANCHORS = `# === C2PA-TRUST-LIST.pem (signing CAs) ===
...
-----END CERTIFICATE-----
# === C2PA-TSA-TRUST-LIST.pem (timestamp CAs) ===
...
export const C2PA_TRUST_CONFIG = `//id-kp-emailProtection 
1.3.6.1.5.5.7.3.4
