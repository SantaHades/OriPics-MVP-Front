// 사진함 사진 요약 (2026-09-13 A-98) — 폴링 경량화. 앱·웹 상세가 15초마다 사진 목록 전체(≤500행 + 링크 + 열람 정보)를
//   재수신하던 것을, 이 3개 값만 먼저 받아 이전 값과 다를 때만 목록을 다시 받게 한다.
//   unread_total = 뷰어 기준 미열람 사진 수(사진함 목록 카드의 unread_count와 같은 정의) = photo_count − 뷰어의 열람 행 수.
