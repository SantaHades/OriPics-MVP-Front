  ...
  return (
    <article className="prose prose-slate max-w-none">
      ...
      <ol>
        ...
        <li><strong>사진함 패스:</strong> 등록하지 않은 코드는 결제일로부터 7일 이내 전액 환불(청약철회)됩니다. 사진함에 등록한 뒤에는 서비스 제공이 개시되므로 같은 법 제17조 제2항에 따라 남은 장수의 청약철회가 제한되며, 사진함에서 나가거나 내보내진 경우·사진함이 삭제된 경우·회원 탈퇴 시에도 환불되지 않습니다(개설자가 대신 지불한 패스 포함). 사진함에서 나간 뒤 다시 초대받아 참여하면 남은 장수가 복구됩니다. 이 내용은 결제 화면에서 사전 고지하고 동의를 받습니다.</li>
...
function TermsEn() {
  return (
    <article className="prose prose-slate max-w-none">
      ...
      <ol>
        <li><strong>Photo Box Pass:</strong> Unregistered codes are fully refundable within 7 days of payment. Once registered to a photo box, service provision has begun and withdrawal for the remaining photos is limited under Article 17(2); no refund is made when you leave or are removed from the photo box, when the photo box is deleted, or when you delete your account (including passes paid by the owner). Rejoining by invitation restores the remaining photos. This is disclosed and agreed to at checkout.</li>
