...
const T = {
  ko: {
    back: "패스 소개로",
    title: "원데이 패스 구매",
    subtitle: "결제하면 패스가 내 계정에 담겨요 — 사용을 시작하기 전까지 24시간은 흐르지 않아요.",
    product: "원데이 패스 1장",
    priceNote: "부가세 포함",
    productDesc: "시작 후 24시간 · 촬영 인증 10회 · 인증서 PDF · 공개링크 1년 보관 · 구매 계정 전용",
    phoneLabel: "휴대폰 번호",
    phonePlaceholder: "01012345678",
    phoneHint: "카드사 결제창에 필요해요 (숫자만 입력).",
    phoneInvalid: "휴대폰 번호를 확인해 주세요 (01로 시작하는 숫자).",
    refundNotice: "사용 시작 전에는 환불할 수 있으나, 사용 시작 후에는 환불이 불가합니다. 구매한 패스는 구매 계정 전용입니다. 자세한 내용은",
  ...
  en: {
    ...
    subtitle: "The pass is kept on your account after payment — the 24 hours don't start until you start using it.",
    product: "One-Day Pass ×1",
    priceNote: "VAT included",
    productDesc: "24h from start · 10 capture proofs · certificate PDF · 1-year links · account-exclusive",
    ...
    refundNotice: "Refundable before you start using the pass; non-refundable once started. Purchased passes are exclusive to the purchasing account. For details, see the",
